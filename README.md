# TP2 - Bucles
Este proyecto es una recopilación de ejercicios realizados como parte del Trabajo Práctico 2 del Módulo 2 sobre JavaScript. Está orientado a la práctica de conceptos básicos del lenguaje y su interacción con HTML.
...
El uso de Estructura If, bucles while, do while, switch, for.
...
```https://github.com/heagustina/tp2-Bucles```
